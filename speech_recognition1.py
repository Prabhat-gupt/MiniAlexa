...
def run_alexa():
    ...
    try:
        ...
        if 'hello' in command :
            ...
            engine_talk('Enter the mobile number')
            num = input("Enter the mobile number")
            engine_talk('Enter the time')
            hour = int(input("Enter the time"))
            engine_talk('Enter the minutes')
            minu = int(input("Enter the minutes"))
            engine_talk('Enter the message')
            message = input("Enter the message")
            pywhatkit.sendwhatmsg("+91"+num, message, hour, minu)
            time.sleep(5)
            pg.press('Enter')
        ...
        elif 'open ms teams' in command:
            print('Opening Msteams....')
            engine_talk('opening ms teams.....')
            # time.sleep(1)
            subprocess.call('C://Users//hp//AppData//Local//Microsoft//Teams//Update.exe --processStart "Teams.exe"')
            time.sleep(1)
            ...
            subprocess.call('C:\\Users\\hp\\AppData\\Roaming\\Microsoft\\Windows\\Start Menu\\Programs\\System Tools\\cmd.exe')
